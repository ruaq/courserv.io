                ...
                <div class="space-y-3">
                    ...
                    <div x-data="{ leadingPosition: @entangle('editing.leading').defer }" class="space-y-3">
                        <div class="flex items-center">
                            <button type="button" class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 bg-gray-200" role="switch" aria-checked="false" x-ref="switch" :aria-checked="leadingPosition" @click="leadingPosition = !leadingPosition" x-state:on="Enabled" x-state:off="Not Enabled" :class="{ 'bg-indigo-600': leadingPosition, 'bg-gray-200': !(leadingPosition) }">
                                <span class="sr-only">{{ _i('leading position') }}</span>
                                <span class="pointer-events-none relative inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200 translate-x-0" x-state:on="Enabled" x-state:off="Not Enabled" :class="{ 'translate-x-5': leadingPosition, 'translate-x-0': !(leadingPosition) }">
                                        <span class="absolute inset-0 h-full w-full flex items-center justify-center transition-opacity opacity-100 ease-in duration-200" aria-hidden="true" x-state:on="Enabled" x-state:off="Not Enabled" :class="{ 'opacity-0 ease-out duration-100': leadingPosition, 'opacity-100 ease-in duration-200': !(leadingPosition) }">
                                        ...
                                        <span class="absolute inset-0 h-full w-full flex items-center justify-center transition-opacity opacity-0 ease-out duration-100" aria-hidden="true" x-state:on="Enabled" x-state:off="Not Enabled" :class="{ 'opacity-100 ease-in duration-200': leadingPosition, 'opacity-0 ease-out duration-100': !(leadingPosition) }">
